...
export const regions = [
  { id: 'riyadh', ar: 'الرياض', en: 'Riyadh', lat: 24.71, lng: 46.68, pop: '8.59M', traitAr: 'الرؤية', traitEn: 'Vision', img: 'KING ABDULLAH FINANCIAL DISTRICT',
    ...
    historyAr: 'من بلدة طينية محاطة بسورٍ إلى عاصمةٍ تضم أكثر من رُبع سكان المملكة.',
    historyEn: 'From a walled mud-brick town to a capital region holding more than a quarter of the Kingdom’s people.',
  ...
  { id: 'makkah', ar: 'مكة المكرمة', en: 'Makkah', lat: 21.42, lng: 40.5, pop: '7.77M', traitAr: 'الجود', traitEn: 'Generosity', img: 'PILGRIMS AT DAWN — WIDE',
    ...
    facts: ['جدة التاريخية «بوابة مكة» على قائمة اليونسكو منذ ٢٠١٤', 'ميناء جدة الإسلامي: أكبر موانئ المملكة على البحر الأحمر', '١٫٧ مليون حاج في ٢٠٢٦'] },
...
export const regionDetails = {
  riyadh: {
    ...
    storyAr: 'في ليلة من يناير ١٩٠٢ تسلّق أربعون رجلاً سور الرياض، ومع الفجر كان قصر المصمك بداية حكاية توحيد الجزيرة. من تلك الليلة إلى أبراجٍ تمتد على مد البصر: الرياض ما تغيّرت — كبرت على نفس العزم.',
    storyEn: 'One night in January 1902, forty men scaled the walls of Riyadh. By dawn, Masmak Fortress had become the opening line of unification. From that night to a skyline without end — Riyadh didn’t change its nature; it grew on the same resolve.',
    numbers: [
      ...
      { v: '25%+', ar: 'من سكان المملكة يعيشون في المنطقة', en: 'Of the Kingdom’s population', src: 'GASTAT · 2024' },
    ],
  },
  makkah: {
  ...
  eastern: {
    ...
    storyAr: 'سبع محاولات خائبة كادت توقف كل شيء… ثم تدفّق بئر الدمام رقم ٧ في ١٩٣٨ وغيّر مسار المنطقة والعالم. وقبل النفط بخمسة آلاف عام كانت تاروت ميناءً يتاجر مع حضارات ما بين النهرين. الشرقية ما بدأت مع النفط — النفط هو اللي لحق بها.',
    storyEn: 'Seven dry wells nearly ended it all — then Dammam Well No. 7 flowed in 1938 and changed the region and the world. Five thousand years before oil, Tarout was already a port trading with Mesopotamia. The Eastern Province didn’t begin with oil; oil caught up with it.',
    numbers: [
  ...
  qassim: {
    ...
    storyAr: 'قبل شاحنات التبريد، كانت قوافل القصيم توصل التمر إلى الشام والعراق وتعود بالحكايات. اليوم يمرّ من مزاد بريدة في الموسم الواحد ما يُوزن بمئات آلاف الأطنان — والصفقة لا تزال تنعقد بكلمة، والضيف لا يزال يخرج وبيده تمر.',
    storyEn: 'Before refrigerated trucks, Qassim’s caravans carried dates to the Levant and Iraq and came back with stories. Today, hundreds of thousands of tonnes pass through Buraidah’s auction each season — a deal is still sealed with a word, and no guest leaves empty-handed.',
    numbers: [
  ...
  tabuk: {
    ...
    numbers: [
      ...
      { v: '1907', ar: 'وصول سكة حديد الحجاز إلى تبوك', en: 'The Hejaz Railway reaches Tabuk', src: 'MOC' },
    ],
  },
  hail: {
    ...
    numbers: [
      ...
      { v: '2020', ar: 'حائل محطة في رالي داكار السعودية', en: 'Hail joins the Dakar Rally route', src: 'DAKAR' },
    ],
  },
  jawf: {
    ...
    storyAr: 'ذُكرت دومة الجندل في نقوش الآشوريين قبل الميلاد، وصمدت قلعة مارد حتى قيل فيها: «تمرّد ماردٌ وعزّ الأبلق». واليوم تحيط بالمدينة القديمة ملايين أشجار الزيتون — أقدم مدن الشمال تعصر أحدث زيوته.',
    storyEn: 'Dumat Al-Jandal appears in Assyrian inscriptions from before the common era, and Marid Castle outlasted every siege. Today, millions of olive trees surround the old city — the north’s most ancient town pressing its newest oil.',
    numbers: [
  ...
  najran: {
    ...
    numbers: [
      ...
      { v: '6', ar: 'طوابق تبلغها البيوت الطينية التقليدية', en: 'Storeys of a traditional mud house', src: 'MOC' },
    ],
  },
  northern: {
    ...
    storyAr: 'من هنا مرّ درب زبيدة يسقي حجاج الكوفة من بركٍ محفورة في الصحراء. وتحت السهوب نفسها التي تخضرّ بعد المطر يرقد نحو ٧٪ من فوسفات العالم. أرضٌ تبدو صامتة… وفوقها وتحتها عطاء ما يوقف.',
    storyEn: 'Darb Zubaydah passed through here, watering Kufa’s pilgrims from cisterns dug into the desert. Beneath the same steppes that turn green after rain lies about 7% of the world’s phosphate. A land that seems silent — giving without pause, above ground and below.',
    numbers: [
      { v: '~7%', ar: 'من احتياطي الفوسفات العالمي', en: 'Of the world’s phosphate reserves', src: 'MAADEN' },
      { v: '1,400+', ar: 'عام عمر درب زبيدة', en: 'Years of Darb Zubaydah', src: 'HERITAGE COMMISSION' },
    ],
  },
  bahah: {
    ...
    storyAr: 'بنى أهل ذي عين قريتهم من الحجر فوق تلة من المرمر الأبيض تلمع تحت الشمس كأنها مضيئة من الداخل. وحولها أكثر من أربعين غابة وعسل سدرٍ يُجنى من رؤوس الجبال — الباحة تختصرها كلمة ما تتوقعها في الجزيرة: خضراء.',
    storyEn: 'The people of Dhee Ayn built their village in stone atop a hill of white marble that glows under the sun as if lit from within. Around it: forty-plus forests and sidr honey gathered from mountaintops. Al Bahah is summed up in a word you don’t expect in Arabia: green.',
    numbers: [
...
export const moments = [
  ...
  { y: '2019', cat: 'culture', ar: 'انطلاق موسم الرياض', en: 'Riyadh Season Launches', dAr: 'أكبر موسم ترفيهي وثقافي في المنطقة يفتح أبوابه.', dEn: 'The region’s largest cultural and entertainment season opens.', src: 'GEA', img: 'BOULEVARD AT NIGHT' },
